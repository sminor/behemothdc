...
export default function AdminEvents() {
  ...
  const handleSave = async (eventId: string) => {
    ...
    const isValid = requiredFields.every(
      (field) => eventToSave[field] !== undefined && eventToSave[field] !== ""
    );
    if (!isValid) {
  ...
  const newEvents = Object.values(editedEvents).filter((e) =>
    e.id.startsWith("new-")
  );
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    value={edited.games}
                    onChange={(e) =>
                      handleChange(event.id, "games", e.target.value)
                    }
                    className="w-full p-2 rounded-md border border-[var(--form-border)] bg-[var(--form-background)] text-[var(--select-text)] focus:outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange(event.id, "draw_type", e.target.value)
                    }
                    className="w-full p-2 rounded-md border border-[var(--form-border)] bg-[var(--form-background)] text-[var(--select-text)] focus:outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-2 top-2.5 text-[var(--select-text)]">
                      $
                    </span>
                    <input
                      type="number"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange(event.id, "special_event", e.target.value)
                    }
                    className="w-full p-2 rounded-md border border-[var(--form-border)] bg-[var(--form-background)] text-[var(--select-text)] focus:outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(event.id, "signup_start", e.target.value)
                      }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(event.id, "signup_end", e.target.value)
                      }
                      className="w-1/2 p-2 rounded-md border border-[var(--form-border)] bg-[var(--form-background)] text-[var(--select-text)] focus:outline-none"
                    />
                  </div>
