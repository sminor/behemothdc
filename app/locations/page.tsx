    ...
    <div className="flex flex-col items-center min-h-screen">
      ...
      <div className="w-full max-w-screen-xl mx-auto px-4">
        ...
        <header className="p-4 text-center">
          ...
          <p>With 11 locations around the Portland metro area, Behemoth Darts Club offers convenient spots for you to join the excitement of dart games, leagues, and tournaments. Click on a location to explore more!</p>
        </header>
